...
const RESULT_FRAMING: Record<Intensity, string[]> = {
  ...
  rookie: [
    "Scraped a win.", "Barely cashed.", "Minimum on the board.", "Ugly win is still a win.",
    "Not pretty, but it cashed.", "Grinder of a hand.", "Green ink is green ink.",
    "Take the cash, forget the mechanics.", "These add up over time.", "Floor cash.",
    "Bottom-rung win.", "Just enough.", "Pennies.", "Loose change.", "Rounding-error cash.",
    "Limped over the line.", "Anti-bust hand.", "Avoided the loss column.",
    "Coupon-clipper cash.", "Ledger barely moved.", "Token win.", "Survival cash.",
    "Posted the most modest W.", "Cleared the bar by a foot.", "Just over the line.",
  ],
  bust_close: [
