...
export const RESULT_FRAMING: Record<Intensity, string[]> = {
  legend: [
    "Legend-tier night.", "Historic hand.", "Top-of-the-chart hand.", "Ceiling-kissing hand.",
    "Years from now, still telling this story.", "Bottle that night.", "That one goes in the book.",
    "Top of the mountain.", "Career-defining night.", "All-time hand.", "Goosebumps hand.",
    "One in a thousand.", "Save the box score.", "Frame this one.", "The kind you screenshot.",
    "Hall-of-fame hand.", "Statue-worthy night.", "Banner night.", "Chef's-kiss night.",
    "Rare-air hand.", "Tell your kids about this one.", "Lock-it-in legend.",
    "Once-in-a-decade hand.", "Off-the-charts hand.", "Print-it-and-pin-it night.",
  ],
  mvp: [
    "MVP-level hand.", "Huge night.", "Real one, this.", "Serious hand.",
    "That's a number to remember.", "A number — an actual number.", "Put that one in the highlight reel.",
    "Stack that in the trophy case.", "Statement game.", "Premium hand.", "Top-shelf hand.",
    "Big-boy hand.", "Loaded board.", "Quality night.", "Proper hand.", "Substantial.",
    "That's the one.", "Headliner hand.", "Marquee night.", "Big-time hand.",
    "Gold-standard hand.", "Now we're talking.", "Notable hand.", "Properly fat box score.",
    "Heavyweight hand.",
  ],
  all_star: [
    "Big one.", "All-Star hand.", "Real one tonight.", "That's a hand that counts.",
    "Deep run.", "That's a hand that pays the rent.", "Real hand, real satisfying.", "Big day.",
    "Solid hand.", "Quality hand.", "Above-average hand.", "Tangible result.", "Worth the hype.",
    "Properly done.", "Healthy hand.", "Notable result.", "Cleanly done.", "Pulled it off.",
    "Stuffed the box score.", "Earned it.", "Take a bow.", "Counted board.", "Real-deal hand.",
    "Comfortable hand.", "Above-the-fold result.",
  ],
  starter_dominant: [
    "Cruised through.", "Comfortable win.", "Handled it.", "Had room to spare.",
    "Clean win with cushion.", "Felt like a choice, not a chase.", "Coasted home.",
    "Easy night.", "Wire to wire.", "Foot off the gas.", "Rolled it up.", "Ran the table.",
    "Done before the buzzer.", "Never in doubt.", "Walking-pace win.", "Casual hand.",
    "Drifted in.", "Margin to burn.", "Stress-free hand.", "Relaxed win.",
    "Cleared with ease.", "Slid through it.", "Set and forget.", "Nothing to chase.",
    "Drove it home.",
  ],
  starter_normal: [
    "Clean hand.", "Solid hand.", "Got the job done.", "Pro night.", "Points on the board.",
    "Punched in, punched out.", "Business as usual — boring is a skill.", "Businesslike win.",
    "Day's work.", "Standard hand.", "On-time delivery.", "Wins are wins.", "Quiet, tidy win.",
    "Filed and done.", "Receipts on the table.", "Modest hand.", "Workmanlike.", "Workman's hand.",
    "Done and done.", "Posted the W.", "Closed the loop.", "Nothing fancy, got it done.",
    "Steady-state win.", "Held the line.", "Showed up, got it done.",
  ],
  starter_barely: [
    ...
    "Photo finish.", "Tightrope win.", "Skin-of-teeth hand.", "Fingertip finish.",
    "Won by a hair.", "By the skin.", "Squeezed it out.", "Razor-thin margin.",
    "Wobbled across the line.", "Barely upright.", "Stumbled over the line.", "Limped across.",
  ...
  rookie: [
    ...
    "Kept your seat at the table.", "Subsistence hand.", "Hovered above zero.",
    "Floor-level result.", "Nominal hand.", "Marginal hand.", "Token hand.",
    ...
    "Lukewarm result.", "Stayed in the room.", "Penny-ante hand.",
  ...
  bust_close: [
    ...
    "Tantalizingly close — still zero.", "Heartbreak hand.", "Almost had it.", "Painful inches.",
    ...
    "One free throw away.", "Brutal margin.", "Cruel inches.", "Should've had it.",
    "Could've, didn't.", "One play short.", "Stings extra.", "A whisper short.",
  ],
  bust_mid: [
    "Bust night.", "Came up short.", "Off night across the board.", "Didn't get there.",
    "Hand never landed.", "Chalk it up.", "Next hand.", "Not every hand lands.",
    "Loss column.", "Straight loss.", "Move along.", "Tough hand.", "Closed in the negative.",
...
const ARCHETYPE_FRAMING: Partial<Record<CommentaryArchetype, string[]>> = {
  ...
  star_carried_loss: [
    ...
    "The star card delivered. Nobody else did.",
  ],
  ...
  ugly_win: [
    ...
    "Not the script, but the win's real.",
...
const CHAD_ANALOGIES: Record<Intensity, string[]> = {
  legend: [
    ...
    "Generations from now, archaeologists will find this box score and nod solemnly.",
  ...
  mvp: [
    ...
    "Cleared the table and then some. The and-then-some is the good part.",
    ...
    "The kind of night that doesn't quietly evaporate by Wednesday.",
    "The hand equivalent of the upgraded hotel room you didn't book.",
    "Earned the night. Earned a second one we don't talk about.",
    ...
    "A hand that feels earned, which is rare these days.",
    "Like your order arriving exactly on time AND hot. Take a moment.",
    "That hand had more protein than a steakhouse sampler.",
  ],
  all_star: [
    "The kind of hand that makes you briefly consider believing in things.",
    "Paperwork done, memory filed, evening made.",
    ...
    "Landed the way a well-written letter reads — clean, intentional, nothing extra.",
  ...
  starter_normal: [
    ...
    "Landed like a tax refund you forgot you were getting.",
    ...
    "Not going in the highlight reel. Going in the record. That's the trade.",
  ],
  starter_barely: [
    "Squeaked through like a kid in algebra with a tutor's help.",
    "Photo finish. The scoreboard operator did a double-take.",
    "Close enough that you felt it in your chest. A win's a win.",
    ...
    "One play from heartbreak, one play into the win. That's the margin.",
    "Made it by the skin of whatever the teeth's skin is called.",
    "Bend-don't-break hand. Bent like yoga, didn't snap.",
    "The elevator doors closed on your arm but you made it through. So did this hand.",
  ],
  ...
  rookie: [
    ...
    "Treadmill hand. Moved its feet, went nowhere.",
    ...
    "Net-zero hand with a faint pulse. Officially in the room.",
    ...
    "The stat-line equivalent of a truce. Both sides walked away.",
    "Showed up, signed in, signed out. Neither here nor there.",
    "Quiet result, the kind that arrives in a blank envelope.",
  ],
  bust_close: [
    ...
    "So close it made the hand shake a little. Then it didn't hit.",
  ...
  bust_mid: [
    ...
    "The scoreboard took a nap and nobody woke it up.",
    ...
    "Tonight's result was, unfortunately, a loss.",
