...
const WIN_TIERS: WinTierDisplay[] = [
  ...
  { label: "STARTER",  minFp: 168, color: "#00FFD8", glow: "rgba(0,255,216,0.6)"   },
  { label: "ALL-STAR", minFp: 188, color: "#C084FC", glow: "rgba(192,132,252,0.7)"  },
  { label: "MVP",      minFp: 210, color: "#FB923C", glow: "rgba(251,146,60,0.7)"   },
  { label: "G.O.A.T.", minFp: 238, color: "#EF4444", glow: "rgba(239,68,68,0.9)"   },
];

const LEGEND: LegendData = {
  payoutRows: [
    { label: "G.O.A.T.", score: "238+", payout: "BONUS", color: "#EF4444", bg: "rgba(239,68,68,0.12)",    border: "rgba(239,68,68,0.35)"    },
    { label: "MVP",      score: "210+", payout: "15x",   color: "#FB923C", bg: "rgba(251,146,60,0.10)",   border: "rgba(251,146,60,0.3)"    },
    { label: "ALL-STAR", score: "188+", payout: "7x",    color: "#C084FC", bg: "rgba(192,132,252,0.10)",  border: "rgba(192,132,252,0.25)"  },
    { label: "STARTER",  score: "168+", payout: "2.5x",  color: "#00FFD8", bg: "rgba(0,255,216,0.08)",  border: "rgba(0,255,216,0.25)"   },
    { label: "ROOKIE",   score: "148+", payout: "0.5x",  color: "#22C55E", bg: "rgba(34,197,94,0.10)",   border: "rgba(34,197,94,0.25)"    },
    { label: "BUST",     score: "<148", payout: "—",     color: "#6B7280", bg: "rgba(107,114,128,0.08)", border: "rgba(107,114,128,0.2)"   },
  ],
  bonusRows: [
