...
const WIN_TIERS: WinTierDisplay[] = [
  { label: "ROOKIE",   minFp: 130, color: "#22C55E", glow: "rgba(34,197,94,0.6)"    },
  { label: "STARTER",  minFp: 155, color: "#00FFD8", glow: "rgba(0,255,216,0.6)"   },
  { label: "ALL-STAR", minFp: 180, color: "#C084FC", glow: "rgba(192,132,252,0.7)"  },
  { label: "MVP",      minFp: 205, color: "#FB923C", glow: "rgba(251,146,60,0.7)"   },
...
const LEGEND: LegendData = {
  payoutRows: [
    ...
    { label: "MVP",      score: "205+", payout: "15x",   color: "#FB923C", bg: "rgba(251,146,60,0.10)",   border: "rgba(251,146,60,0.3)"    },
    { label: "ALL-STAR", score: "180+", payout: "7x",    color: "#C084FC", bg: "rgba(192,132,252,0.10)",  border: "rgba(192,132,252,0.25)"  },
    { label: "STARTER",  score: "155+", payout: "2.5x",  color: "#00FFD8", bg: "rgba(0,255,216,0.08)",  border: "rgba(0,255,216,0.25)"   },
    { label: "ROOKIE",   score: "130+", payout: "0.5x",  color: "#22C55E", bg: "rgba(34,197,94,0.10)",   border: "rgba(34,197,94,0.25)"    },
    { label: "BUST",     score: "<130", payout: "—",     color: "#6B7280", bg: "rgba(107,114,128,0.08)", border: "rgba(107,114,128,0.2)"   },
  ],
  bonusRows: [
