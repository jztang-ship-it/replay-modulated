...
import { __devForceTopGame } from "../../../shared/data/__devForceTopGame"; // DEV-ONLY: remove before merge
...
export default function GameView() {
  ...
  const topGameInfo = useMemo(() => {
    ...
    // DEV-ONLY: ?forceTopGame=all_time|season|career short-circuits detection. Remove before merge.
