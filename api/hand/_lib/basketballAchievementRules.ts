// Server-only copy of the basketball achievement predicates.
// It is intentionally not imported from the browser bundle: the server owns
// the input context and the database write.
import type { AchievementDef, AchievementContext } from "../../../shared/achievements/types.js";
import { registerAchievements } from "../../../shared/achievements/registry.js";
