...
/**
 * Map StatsBomb event type to our stat categories
 */
function mapEventToStat(eventType: string): string | null {
  const mapping: Record<string, string | null> = {
    'Shot': 'shots',
    'Goal': 'goals',
    'Pass': null, // We track assists separately
    'Foul Committed': null,
    'Card': null, // We track yellow/red cards separately
  };
