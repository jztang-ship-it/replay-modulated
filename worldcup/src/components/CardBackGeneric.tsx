/**
 * CardBackGeneric.tsx — World Cup
 * LAYER 1: Branded face-down card back (sport-agnostic)
 * Shows during: initial deal, after DRAW (before emotional reveal)
 */
  ...
  return (
    ...
    >
      ...
      <div style={{ position: "relative", width: 64, height: 64, display: "flex", alignItems: "center", justifyContent: "center" }}>
        ...
        <span style={{ fontSize: 22, fontWeight: 950, color: "rgba(255,177,74,0.35)", letterSpacing: -1, fontStyle: "italic", lineHeight: 1 }}>R</span>
      </div>

      {/* Bottom wordmark */}
      <div style={{ position: "absolute", bottom: 14, left: 0, right: 0, textAlign: "center", fontSize: 7, fontWeight: 900, letterSpacing: 3, color: "rgba(255,177,74,0.2)", textTransform: "uppercase" }}>
        REPLAY FS
      </div>
