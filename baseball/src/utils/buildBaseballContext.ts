/**
 * baseball/src/utils/buildBaseballContext.ts
...
/**
 * PLAYER_CULTURE is keyed by lowercase last name (e.g. "verlander", "judge").
...
function pickRelevantTones(
  ...
  // Always include 1-2 generic tier-flavor lines
  const tier = (culture.salaryTier ?? "").toLowerCase();
